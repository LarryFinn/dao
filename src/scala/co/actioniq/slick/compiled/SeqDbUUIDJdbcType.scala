...
abstract class SeqDbUUIDJdbcType[T <: BoundedSeq[DbUUID] : ClassTag] extends AiqSlickProfile.DriverJdbcType[T] {
...
class SeqDbUUIDJdbcTypeBase extends SeqDbUUIDJdbcType[BoundedSeq[DbUUID]]
class SeqDbUUIDJdbcType100 extends SeqDbUUIDJdbcType[BoundedSeq100[DbUUID]]
class SeqDbUUIDJdbcType200 extends SeqDbUUIDJdbcType[BoundedSeq200[DbUUID]]
class SeqDbUUIDJdbcType500 extends SeqDbUUIDJdbcType[BoundedSeq500[DbUUID]]
class SeqDbUUIDJdbcType1000 extends SeqDbUUIDJdbcType[BoundedSeq1000[DbUUID]]
